...
\begin{itemize}[label={$\rightarrow$}]
    ...
    \item If $\langle n, v \rangle = 0$ and $r_0$ lies on the plane: all $\lambda \in \mathbb{R}$ satisfy it — the line lies entirely in the plane.
\end{itemize}
...
\noindent Taking $n = (2, 1, -1)$ and $R_0 = (2, 0, 0)$ on the plane, Equation~(\ref{eq:dist-pt-plane}) gives:
\[
...
Distance = distance from any point on the line to the plane (use Equation~(\ref{eq:dist-pt-plane})).
...
\bibitem{algebra1}
\textit{Algebra I --- Lecture Notes}, version~3,
University of Primorska FAMNIT\@.
Available at:\\
\url{https://e.famnit.upr.si/pluginfile.php/747259/mod_resource/content/19/Algebra%201%20lecture%20notes_V3.pdf}
